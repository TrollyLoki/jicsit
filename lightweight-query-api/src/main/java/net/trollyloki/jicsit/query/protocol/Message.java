...
import net.trollyloki.jicsit.query.ProtocolException;
import net.trollyloki.jicsit.query.protocol.payload.CookiePayload;
import net.trollyloki.jicsit.query.protocol.payload.RawPayload;
import net.trollyloki.jicsit.query.protocol.payload.ServerStatePayload;
